  ...
  A cross-reference to Section 1 of Document 1: :ref:`label_ssa`
  
  .. rubric:: \:numref:
  
  A numbered cross-reference to a section of Document 1: :numref:`label_ssb` 
  
  .. rubric:: \:download:
  
  A cross-reference to a downloadable file: :download:`download main.py <../../src/python_package/main.py>`
  ...
  A cross-reference to a Python module: :py:mod:`python_package.subpackage_1.module_1`
  
  A cross-reference to a Python module (just the name): :py:mod:`~python_package.subpackage_1.module_1`
  
  A cross-reference to a Python module (no hyperlink): :py:mod:`!python_package.subpackage_1.module_1`
  
  .. rubric:: \:py:func:
  
  A cross-reference to a Python function: :py:func:`python_package.subpackage_1.module_1.function_one`
  
  A cross-reference to a Python function (just the name): :py:func:`~python_package.subpackage_1.module_1.function_one`
  
  .. rubric:: \:py:class:
  
  A cross-reference to a Python class: :py:class:`python_package.subpackage_1.module_1.Class_One`
  
  A cross-reference to a Python class: :py:class:`~python_package.subpackage_1.module_1.Class_One`
  
  .. rubric:: \:py:attr:
  
  A cross-reference to a Python attribute: :py:attr:`python_package.subpackage_1.module_1.Class_One.public_attribute_one`
  
  A cross-reference to a Python attribute: :py:attr:`~python_package.subpackage_1.module_1.Class_One.public_attribute_one`
  
  .. rubric:: \:py:meth:
  
  A cross-reference to a Python method: :py:meth:`python_package.subpackage_1.module_1.Class_One.public_method_one`
  ...
  * :ref:`search`
  ...
  .. toctree::
     ...
     API reference <_autosummary/python_package>